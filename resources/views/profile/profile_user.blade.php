                            ...
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle"
                                        src="{{ asset('img_user/'.Auth::user()->img ) }}" alt="User profile picture" style="width: 160px; height: 160px;">
                                </div>
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="activity">
                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm"
                                                    src="{{ asset('tamplate/dist/img/user1-128x128.jpg') }}" alt="user image">
                                                <span class="username">
                                        ...
                                        <div class="post clearfix">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm"
                                                    src="{{ asset('tamplate/dist/img/user7-128x128.jpg') }}" alt="User Image">
                                                <span class="username">
                                                    <a href="#">Sarah Ross</a>
                                                    <a href="#" class="float-right btn-tool"><i
                                                            class="fas fa-times"></i></a>
                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm"
                                                    src="{{ asset('tamplate/dist/img/user6-128x128.jpg') }}" alt="User Image">
                                                <span class="username">
                                                    <a href="#">Adam Jones</a>
                                                    <a href="#" class="float-right btn-tool"><i
                                                            class="fas fa-times"></i></a>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-6">
                                                    <img class="img-fluid" src="{{ asset('tamplate/dist/img/photo1.png') }}" alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <img class="img-fluid mb-3" src="{{ asset('tamplate/dist/img/photo2.png') }}"
                                                                alt="Photo">
                                                            <img class="img-fluid" src="{{ asset('tamplate/dist/img/photo3.jpg') }}"
                                                                alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                        <div class="col-sm-6">
                                                            <img class="img-fluid mb-3" src="{{ asset('tamplate/dist/img/photo4.jpg') }}"
                                                                alt="Photo">
                                                            <img class="img-fluid" src="{{ asset('tamplate/dist/img/photo1.png') }}"
                                                                alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form action="/updata_user/{{Auth::user()->id}}" method="post" enctype="multipart/form-data">
                                            @csrf
